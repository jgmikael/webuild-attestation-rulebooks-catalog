...
- `parent_economic_operator_additional_id`, `site_additional_ids`, and
  `site_additional_addresses` are optional and **MAY** contain zero or more entries.
...
- The attestation **MUST** be linked to the economic operator by providing at least one unique
  identifier in `parent_economic_operator_main_id`.
...
|------------------------------------------|------------------------|----------------------------------------------------------------------------------------------------|------------------|
| parent_economic_operator_main_id         | [legalIdentifier](https://w3id.org/ebwv#legalIdentifier)  | Primary unique identifier of the economic operator that operates this site (preferred: EUID)       | String           |
| parent_economic_operator_additional_id   | [identifier](https://w3id.org/ebwv#identifier)  | Array of additional identifiers for the economic operator                                          | Array of Strings |
| site_name                                | [schema:name](https://schema.org/name) | The name of the site                                                                               | String           |
| site_main_id                             | [identifier](https://w3id.org/ebwv#identifier) | Globally unique identifier of the site, generated by the EBW as a UUID                            | UUID (String)    |
| site_additional_ids                      |  | Array of additional site-level identifiers                                                         | Array of Strings |
| site_main_address                        | [locationAddress](https://w3id.org/ebwv#locationAddress)  | Physical main address of the site                                                                  | Object (Address) |
...
|------------------------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------------------------------------|
| parent_economic_operator_main_id   | [isSiteOf](https://w3id.org/ebwv#legalIdentifier).[legalIdentifier](https://w3id.org/ebwv#legalIdentifier) | The Economic Operator ID containing at least one ID (preferred: EUID)                                                                                                         | String         | European Business Wallet Vocabulary v0.1  |
| site_name                          | [Site](https://w3id.org/ebwv#Site).[schema:name](https://schema.org/name) | The name of the site                                                                                                                                                          | String         | The Organization Ontology                 |
...
| site_main_address                  | [locationAddress](https://w3id.org/ebwv#locationAddress) | Physical main address of the site                                                                                                                                             | Address object | Core Location Vocabulary                  |
...
- `parent_economic_operator_additional_id`, when present, **SHALL** be an array of
  non-empty strings using identifier types from Section 2.8.1.
...
`site_name`, `site_main_id`, `site_main_address`, `site_additional_addresses`) **SHALL** be
individually selectively disclosable, enabling an economic operator to disclose only the
...
{
{
  ...
  "parent_economic_operator_additional_id": [
    "BPNL000000000001",
    "DE811001001"
  ],
